                            ...
                            >
                                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                                    <button type='button' className='absolute top-2 right-2 z-10 w-fit p-2 bg-primary-blue-100 rounded-full' onClick={closeModal}>
                                        <Image src="/close.svg" alt='close btn' width={20} height={20} className='object-contain' />
                                    </button>
                                    ...
                                    <div className='flex-1 flex flex-col gap-3'>
                                        ...
                                        <div className='flex gap-3'>
                                            ...
                                            <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                                <Image src={generateCarImageUrl(car, '33')} alt="car model" fill priority className="object-contain mt-4" />
                                            </div>
                                            <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
